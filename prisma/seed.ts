...
async function main() {
  ...
  await prisma.service.createMany({
    data: [
      // Trading
      { name: "oms-api", type: "API", systemId: oms.id },
      { name: "oms-order-worker", type: "WORKER", systemId: oms.id },
      { name: "oms-expiry-scheduler", type: "CRONJOB", systemId: oms.id },
      { name: "trading-engine-core", type: "API", systemId: tradingEngine.id },
      { name: "trading-engine-fix-gateway", type: "BACKGROUND_SERVICE", systemId: tradingEngine.id },
      { name: "position-manager-api", type: "API", systemId: positionManager.id },
      { name: "position-manager-calculator", type: "WORKER", systemId: positionManager.id },
      { name: "position-eod-job", type: "CRONJOB", systemId: positionManager.id },
      { name: "algo-trading-api", type: "API", systemId: algoTrading.id },
      { name: "algo-strategy-runner", type: "WORKER", systemId: algoTrading.id },
      // Onboarding
      { name: "customer-portal-web", type: "API", systemId: customerPortal.id },
      { name: "mobile-bff-api", type: "API", systemId: mobileBff.id },
      { name: "mobile-bff-cache-warmer", type: "CRONJOB", systemId: mobileBff.id },
      { name: "kyc-api", type: "API", systemId: kycService.id },
      { name: "kyc-document-processor", type: "WORKER", systemId: kycService.id },
      { name: "account-api", type: "API", systemId: accountService.id },
      { name: "account-event-publisher", type: "WORKER", systemId: accountService.id },
      // Market Data
      { name: "market-data-ingestion", type: "BACKGROUND_SERVICE", systemId: marketDataFeed.id },
      { name: "market-data-normalizer", type: "WORKER", systemId: marketDataFeed.id },
      { name: "quote-service-api", type: "API", systemId: quoteService.id },
      { name: "quote-ws-server", type: "BACKGROUND_SERVICE", systemId: quoteService.id },
      { name: "historical-data-api", type: "API", systemId: historicalData.id },
      { name: "historical-data-aggregator", type: "CRONJOB", systemId: historicalData.id },
      // Settlement
      { name: "settlement-api", type: "API", systemId: settlementEngine.id },
      { name: "settlement-processor", type: "WORKER", systemId: settlementEngine.id },
      { name: "settlement-reconciliation", type: "CRONJOB", systemId: settlementEngine.id },
      { name: "custody-api", type: "API", systemId: custodyService.id },
      { name: "custody-corporate-actions", type: "WORKER", systemId: custodyService.id },
      { name: "transfer-api", type: "API", systemId: transferService.id },
      { name: "transfer-pix-worker", type: "WORKER", systemId: transferService.id },
      { name: "transfer-ted-scheduler", type: "CRONJOB", systemId: transferService.id },
      // Risk & Compliance
      { name: "risk-engine-api", type: "API", systemId: riskEngine.id },
      { name: "risk-margin-calculator", type: "WORKER", systemId: riskEngine.id },
      { name: "risk-eod-var", type: "CRONJOB", systemId: riskEngine.id },
      { name: "compliance-api", type: "API", systemId: complianceService.id },
      { name: "compliance-aml-scanner", type: "WORKER", systemId: complianceService.id },
      { name: "compliance-cvm-reporter", type: "CRONJOB", systemId: complianceService.id },
      { name: "audit-trail-api", type: "API", systemId: auditTrail.id },
      { name: "audit-trail-indexer", type: "WORKER", systemId: auditTrail.id },
      // Platform
      { name: "api-gateway-proxy", type: "API", systemId: apiGateway.id },
      { name: "auth-service-api", type: "API", systemId: authService.id },
      { name: "auth-token-cleanup", type: "CRONJOB", systemId: authService.id },
      { name: "notification-api", type: "API", systemId: notificationService.id },
      { name: "notification-email-worker", type: "WORKER", systemId: notificationService.id },
      { name: "notification-sms-worker", type: "WORKER", systemId: notificationService.id },
    ],
  });
